...
SUBSCRIPTION_PERMISSION = [
            ('advance', 'Advance Perm'), # subscription.advance
...
class Subscription(models.Model):
    ...
    limit_choices_to={"content_type__app_label" : "subscription", 
    ...
    features = models.TextField(help_text="Feature For Pricing by Separated Line" , blank=True, null=True)
...
class UserSubscription(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("Subscription_Details")
    
    def get_cancel_url(self):
        return reverse("Subscription_Cancel")
    
    @property
    def is_active_status(self):
        return self.status in [UserSubscription.SubscriptionStatus.ACTIVE, UserSubscription.SubscriptionStatus.TRIALING]
    ...
    """
    Optional dilay to strat new subscription  in Stripe Checkout 
    """
    @property
